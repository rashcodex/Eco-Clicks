...
function OrderManagement() {
  const Rows = [
    { id: 32143, created: '2 min ago', customer: 'Rashad Zaky ', total: 5645, profit: { amount: 795, percent: 86 }, status: 'Pending' },
    { id: 23241, created: '12 min ago', customer: 'Rashad Fawzy ', total: 1355, profit: { amount: 566, percent: 41 }, status: 'Confirmed' },
    { id: 5643, created: '32 min ago', customer: 'Rashad Mohamed  ', total: 346, profit: { amount: 421, percent: 4 }, status: 'Processing' },
    { id: 67454, created: '17 min ago', customer: 'Rashad Zaky ', total: 8563, profit: { amount: 865, percent: 98 }, status: 'Picked' },
    { id: 85675, created: '22 min ago', customer: 'Rashad Fawzy', total: 864, profit: { amount: 64, percent: 32 }, status: 'Shipped' },
    { id: 9567, created: '5 min ago', customer: 'Rashad Mohamed ', total: 657, profit: { amount: 24, percent: 16 }, status: 'Delivered' },
    { id: 12324, created: '21 min ago', customer: 'Rashad Fawzy ', total: 4124, profit: { amount: 321, percent: 5 }, status: 'Cancelled' }
  ];
